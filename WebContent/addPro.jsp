...
<body>
	...
	<div class="container">
		...
		<form action="AddProductCtrl" method="post" name="frm">
			<table class="table">
				<tr>	
					<th class="item1">상품타입</th>
					<td class="item2">
						<input type="text" name="ptype" id="ptype" value="" />
					</td>
				</tr>
				<tr>	
				...
				<tr>
					...
					<td class="item2">
						<textarea name="pinfo" id="pinfo"  cols="90" rows="10"></textarea>
					</td>
				</tr>
				<tr>	
				...
				<tr>	
					...
					<td class="item2">
						<input type="number" name="pcnt" id="pcnt" max="100" min="1" value="" />
					</td>
				</tr>
				<tr>	
				...
				<tr>
					...
					<td class="item2">
						<span>관리자</span>
						<input type="hidden" name="mname" value="관리자" />
					</td>
				</tr>
			</table>
			<!--  버튼 그룹 -->
